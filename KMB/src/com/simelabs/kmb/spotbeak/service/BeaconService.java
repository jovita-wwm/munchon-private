...
int timeinterval=PublicValues.BeaconRefreshInterval;
long scan=timeinterval;

    this.foregroundScanPeriod = new ScanPeriodData(TimeUnit.SECONDS.toMillis(scan), TimeUnit.SECONDS.toMillis(0L));
