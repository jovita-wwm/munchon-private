...
import com.simelabs.munchon.Beacon.service.BeaconService;
import com.simelabs.munchon.Beacon.service.MonitoringResult;
import com.simelabs.munchon.Beacon.service.RangingResult;
import com.simelabs.munchon.Beacon.service.ScanPeriodData;
...
public class BeaconManager
{
  ...
  public BeaconManager(Context context)
  {
    ...
    this.rangedRegionIds = new HashSet();
    this.monitoredRegionIds = new HashSet();
  }
    ...
    throws RemoteException
  {
    ...
    startRangingMsg.getData().putParcelable("region", region);
    ...
    throws RemoteException
  {
    ...
    startMonitoringMsg.getData().putParcelable("region", region);
  ...
  private void internalStopMonitoring(String regionId)
    throws RemoteException
  {
    this.monitoredRegionIds.remove(regionId);
    Message stopMonitoringMsg = Message.obtain(null, 5);
    stopMonitoringMsg.getData().putString("regionId", regionId);
    try
    {
    ...
    public void handleMessage(Message msg)
    {
      ...
      case 3: 
        if (BeaconManager.this.rangingListener != null)
        {
          ...
          RangingResult rangingResult = (RangingResult)msg.getData().getParcelable("rangingResult");
      ...
      case 6: 
        ...
        {
          msg.getData().setClassLoader(MonitoringResult.class.getClassLoader());
          MonitoringResult monitoringResult = (MonitoringResult)msg.getData().getParcelable("monitoringResult");
      ...
      case 8: 
        if (BeaconManager.this.errorListener != null)
        {
          Integer errorId = Integer.valueOf(msg.getData().getInt("errorId"));
