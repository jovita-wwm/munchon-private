package com.simelabs.munchon.Beacon.service;
...
import com.simelabs.munchon.Beacon.Beacon;
import com.simelabs.munchon.Beacon.Region;
import com.simelabs.munchon.Beacon.Utils;
import com.simelabs.munchon.Beacon.internal.Preconditions;
import com.simelabs.munchon.Beacon.utils.L;
  ...
  extends Service
{
  ...
  public BeaconService()
  {
    ...
    this.foregroundScanPeriod = new ScanPeriodData(TimeUnit.SECONDS.toMillis(2L), TimeUnit.SECONDS.toMillis(0L));
...
private void startScanning()
  ...
  private void sendError(Integer errorId)
  {
    if (this.errorReplyTo != null)
    {
      ...
      errorMsg.getData().putInt("errorId", errorId.intValue());
      try
      {
    ...
    implements Runnable
  {
    ...
    {
      List<MonitoringRegion> didEnterRegions = new ArrayList();
      for (Map.Entry<Beacon, Long> entry : BeaconService.this.beaconsFoundInScanCycle.entrySet()) {
    ...
    {
      List<MonitoringRegion> results = new ArrayList();
    ...
    {
      List<MonitoringRegion> didExitMonitors = new ArrayList();
      for (MonitoringRegion monitoredRegion : BeaconService.this.monitoredRegions) {
    ...
    private void invokeCallbacks(List<MonitoringRegion> enteredMonitors, List<MonitoringRegion> exitedMonitors)
    {
      ...
      for (MonitoringRegion didEnterMonitor : enteredMonitors)
      {
        ...
        monitoringResponseMsg.getData().putParcelable("monitoringResult", new MonitoringResult(didEnterMonitor.region, Region.State.INSIDE, didEnterMonitor.getSortedBeacons()));
        try
        {
      ...
      {
        Message monitoringResponseMsg = Message.obtain(null, 6);
      //  monitoringResponseMsg.getData().putParcelable("monitoringResult", new MonitoringResult(didEnterMonitor.region, Region.State.OUTSIDE, Collections.emptyList()));
        try
        {
          didEnterMonitor.replyTo.send(monitoringResponseMsg);
        }
    ...
    public void run()
    {
      ...
      //  BeaconService.this.setAlarm(BeaconService.this.scanStartBroadcastPendingIntent, BeaconService.access$800(BeaconService.this));
      }
    }
  }
      ...
      BeaconService.this.handler.post(new Runnable()
      {
        public void run()
        {
          ...
          case 1: 
            ...
            RangingRegion rangingRegion = new RangingRegion((Region)bundle.getParcelable("region"), replyTo);
            BeaconService.this.startRanging(rangingRegion);
            break;
          case 2: 
            BeaconService.this.stopRanging(bundle.getString("regionId"));
            break;
          case 4: 
            bundle.setClassLoader(Region.class.getClassLoader());
            MonitoringRegion monitoringRegion = new MonitoringRegion((Region)bundle.getParcelable("region"), replyTo);
          ...
          case 9: 
            ...
            BeaconService.this.foregroundScanPeriod = ((ScanPeriodData)bundle.getParcelable("scanPeriod"));
            break;
          case 10: 
            L.d("Setting background scan period: " + BeaconService.this.backgroundScanPeriod);
            bundle.setClassLoader(ScanPeriodData.class.getClassLoader());
            BeaconService.this.backgroundScanPeriod = ((ScanPeriodData)bundle.getParcelable("scanPeriod"));
            break;
          case 3: 
          case 6: 
          case 8: 
          default: 
            L.d("Unknown message: what=" + what + " bundle=" + bundle);
          }
        }
      });
    }
    ...
    implements BluetoothAdapter.LeScanCallback
  {
    ...
    public void onLeScan(BluetoothDevice device, int rssi, byte[] scanRecord)
    {
      ...
      if ((beacon != null))
      {
    	...
    	//  Log.i("Beacon Found", ""+device+"  :"+uuid);
        L.v("Device " + device + " is a beacon");
