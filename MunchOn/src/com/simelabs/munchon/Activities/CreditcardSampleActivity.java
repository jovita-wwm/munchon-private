...
public class CreditcardSampleActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_creditcardscanmain);

        Intent serv = new Intent(this, PayPalService.class);
        serv.putExtra(PayPalService.EXTRA_PAYPAL_CONFIGURATION, config);
        startService(serv);
