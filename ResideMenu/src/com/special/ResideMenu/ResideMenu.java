...
public class ResideMenu extends FrameLayout{
    ...
    private ImageView logo,sponser;
    private Button btnLogin;
    private LinearLayout layoutLeftMenu;
    private LinearLayout layoutRightMenu,LeftMenu,right_menu,fbLayout;
    ...
    private TextView notifCount,compname;
    ...
    private void initViews(Context context){
        ...
        rightlayout=(LinearLayout)findViewById(R.id.layout_right_menu);
       
        fbLayout=(LinearLayout)findViewById(R.id.layout_fb);
        
        imageViewShadow = (ImageView) findViewById(R.id.iv_shadow);
        layoutLeftMenu = (LinearLayout) findViewById(R.id.layout_left_menu);
        imageViewBackground = (ImageView) findViewById(R.id.iv_background);
        logo = (ImageView) findViewById(R.id.logo);
        sponser = (ImageView) findViewById(R.id.sponser);
        btnLogin= (Button)findViewById(R.id.btnLogin);
        displaypic = (CircularImageView) findViewById(R.id.pic);
        displayname = (TextView) findViewById(R.id.name);
        displaylocation = (TextView) findViewById(R.id.location);
        
        listnotif = (ListView) findViewById(R.id.list_notif);
        notifCount = (TextView) findViewById(R.id.title_notif);
        compname = (TextView) findViewById(R.id.compname);
        
        notificationArray = new ArrayList<String>();
    ...
    public void setLogo()
    {
        logo.setImageResource(R.drawable.logoo);
    }
    /**
     * 
     * set the sponser logo
     *
     */
    public void setSponserLogo()
    {
        sponser.setImageResource(R.drawable.sponslogo);
    }
    ...
    /**
     * 
     * add notifications to side menu
     * 
     */
    ...
    public void addNotifications(String message)
    {
        ...
        (activity,R.layout.list_side_notification,R.id.tv_notif, notificationArray);
    	listnotif.setAdapter(arrayAdapter);
        count++;
        String startnotification = "Notifications (";
    	String endnotification = ")";
    	notifCount.setText(startnotification+count+endnotification);
  ...
  /**
   * 
   * Changing visibility of login button
   * 
   */
    public void fbLogin()
    {
    ...
    /*
     * 
     * Setting text to name and location textfields
     * 
     */
    public void getName(String n)
    {
    	displayname.setText(n.toUpperCase());
